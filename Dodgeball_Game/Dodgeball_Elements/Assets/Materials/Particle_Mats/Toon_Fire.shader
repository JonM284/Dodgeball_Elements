	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_23_0 = step( temp_cast_0 , ( ( ( SAMPLE_TEXTURE2D( _Flame_Texture, sampler_Flame_Texture, panner10 ) * SAMPLE_TEXTURE2D( _Flame_Texture, sampler_Flame_Texture, panner11 ) ) + SAMPLE_TEXTURE2D( _Mask, sampler_Mask, uv_Mask ) ) * SAMPLE_TEXTURE2D( _Mask, sampler_Mask, uv_Mask ) ) );
				float4 temp_cast_3 = (_Inner_Flame_Amount).xxxx;
				...
				float Occlusion = 1;
				float Alpha = step( temp_cast_5 , ( ( ( SAMPLE_TEXTURE2D( _Flame_Texture, sampler_Flame_Texture, panner10 ) * SAMPLE_TEXTURE2D( _Flame_Texture, sampler_Flame_Texture, panner11 ) ) + SAMPLE_TEXTURE2D( _Mask, sampler_Mask, uv_Mask ) ) * SAMPLE_TEXTURE2D( _Mask, sampler_Mask, uv_Mask ) ) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float Alpha = step( temp_cast_0 , ( ( ( SAMPLE_TEXTURE2D( _Flame_Texture, sampler_Flame_Texture, panner10 ) * SAMPLE_TEXTURE2D( _Flame_Texture, sampler_Flame_Texture, panner11 ) ) + SAMPLE_TEXTURE2D( _Mask, sampler_Mask, uv_Mask ) ) * SAMPLE_TEXTURE2D( _Mask, sampler_Mask, uv_Mask ) ) ).r;
				float AlphaClipThreshold = 0.5;
				float AlphaClipThresholdShadow = 0.5;
...
/*ASEBEGIN
Version=18400
284.8;118.4;832;563;205.4213;-433.6248;1.024306;True;False
Node;AmplifyShaderEditor.RangedFloatNode;5;-3104.942,-136.0307;Float;False;Property;_Noise_2_Speed;Noise_2_Speed;0;0;Create;True;0;0;False;0;False;-0.2;-0.38;-4;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;4;-3098.672,-273.7886;Float;False;Property;_Noise_2_Scale;Noise_2_Scale;1;0;Create;True;0;0;False;0;False;0.3312509;0.524234;-2;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3;-3102.845,-631.408;Float;False;Property;_Noise_1_Scale;Noise_1_Scale;2;0;Create;True;0;0;False;0;False;0.7000934;1.026378;-2;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2;-3092.401,-785.0377;Float;False;Property;_Noise_1_Speed;Noise_1_Speed;3;0;Create;True;0;0;False;0;False;-1.228696;-1.37;-4;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;19;-1493.999,83.51843;Float;True;Property;_Mask;Mask;5;0;Create;True;0;0;False;0;False;None;624f7468779421743ab825c9d931d74a;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;27;-695.6064,284.8937;Float;False;Property;_Inner_Color;Inner_Color;7;0;Create;True;0;0;False;0;False;0,0,0,0;0.8679245,0.4819255,0.0286579,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;37;-2188.637,1379.722;Float;False;Property;_Outter_Color_Gradient;Outter_Color_Gradient;10;0;Create;True;0;0;False;0;False;0,0,0,0;0.5647059,0.07710939,0.03529412,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;29;-2114.726,822.0234;Float;False;Property;_Outter_Color;Outter_Color;8;0;Create;True;0;0;False;0;False;0,0,0,0;0.8584906,0.8512101,0.1741277,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=34BF7F02309C25CDAEFA5B6D02B4F73761F5B18F